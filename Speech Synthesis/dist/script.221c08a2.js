...
function () {
  ...
  SpeechSynthesizer.prototype.init = function () {
    this.msg.text = document.querySelector('[name="text"]').value;
    this.eventHandler();
  };

  SpeechSynthesizer.prototype.eventHandler = function () {
    var _this = this;

    speechSynthesis.addEventListener("voiceschanged", function (e) {
      return _this.populateVoices(e);
    });
    this.voicesDropdown.addEventListener("change", function (e) {
      return _this.setVoice(e);
    });
    this.options.forEach(function (option) {
      return option.addEventListener("change", function (e) {
        return _this.setOption(e);
      });
    });
    this.speakButton.addEventListener("click", function () {
      return _this.toggle();
    });
  ...
  SpeechSynthesizer.prototype.populateVoices = function (e) {
  ...
  SpeechSynthesizer.prototype.setVoice = function (e) {
    this.msg.voice = this.voices.find(function (voice) {
      return voice.name === e.target.value;
    });
    this.toggle();
  };

  SpeechSynthesizer.prototype.toggle = function (startOver) {
    if (startOver === void 0) {
      startOver = true;
    }
  ...
  SpeechSynthesizer.prototype.setOption = function (e) {
